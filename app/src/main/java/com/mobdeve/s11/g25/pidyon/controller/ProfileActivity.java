...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void setListeners() {
                ...
                if (authenticate_task.isSuccessful()) {
                    ...
                    FirebaseAuth.getInstance().getCurrentUser().updatePassword(new_password).addOnCompleteListener(update_task -> {
                        if (update_task.isSuccessful()) {
                            ...
                            Toast.makeText(ProfileActivity.this, "Authentication failed! Check your credentials!", Toast.LENGTH_LONG).show();
                        } else {
        ...
        binding.imageProfile.setOnClickListener(v -> {
            ...
            ImagePicker.Companion.with(ProfileActivity.this).maxResultSize(1000, 1000).cropSquare().compress(1024).start();
        });
    }
    ...
    private void loadUserData() {
        ...
        binding.inputName.setText(getIntent().getStringExtra("USERNAME"));
